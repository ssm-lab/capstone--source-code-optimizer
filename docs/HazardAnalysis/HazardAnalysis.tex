...
\begin{itemize}
    ...
    \item The Testing Module is provided with automated tests that include unit tests for core functionalities, integration tests for module interactions and edge case validations. There is no validation for minimum code coverage as it is decided by the client based on their needs and application complexity, but it is assumed that the provided tests effectively test all core functionalities to detect post refactoring bugs and regressions.
