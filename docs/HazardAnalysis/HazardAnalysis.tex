...
January 2nd, 2025 & Sevhena Walker & Added Symbolic Constants\\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{landscape}
    ...
    \multicolumn{1}{|c|}{\multirow{11}{*}{\rotatebox[origin=c]{90}{\textbf{All Components}}}} & The system shuts down or crashes during an ongoing optimization process. &
...
\begin{enumerate}[label=SCR \arabic*., wide=0pt, leftmargin=*]
    ...
    {\bf Fit Criterion:} \texttt{RISK\_REFACTOR\_THRESH} of high-risk or low-confidence refactorings must require user approval before proceeding.\\
