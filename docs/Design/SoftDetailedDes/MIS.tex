...
\begin{enumerate}
  ...
  \begin{itemize}
  \item \textbf{Used in}: \texttt{refactor} during AST traversal
  ...
  \begin{itemize}
  \item \textbf{Used in}: \texttt{refactor} during analysis
  ...
  \begin{itemize}
  \item \textbf{Used in}: \texttt{find\_scope}
  ...
  \begin{itemize}
  \item \textbf{Used in}: \texttt{refactor} during code modification
  ...
  \begin{itemize}
  \item \textbf{Used in}: \texttt{add\_node\_to\_body}
  ...
  \begin{itemize}
  \item \textbf{Used in}: \texttt{refactor} final stage
  \item \textbf{Transition}:
  \begin{itemize}
...
\begin{itemize}
\item \textbf{Used in}: \texttt{refactor} initialization
...
\begin{itemize}
\item \textbf{Used in}: Call transformation preparation
...
\begin{itemize}
\item \textbf{Used in}: Call validation
...
\begin{itemize}
\item \textbf{Used in}: Type inference fallback
...
\begin{itemize}
\item \textbf{Used in}: AST modification
\item \textbf{Transition}:
\begin{itemize}
...
\begin{itemize}
\item \textbf{Used in}: Cross-file modifications
