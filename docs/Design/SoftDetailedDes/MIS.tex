...
\subsection{Module}
\texttt{PluginInitiator} is a module that initializes the VS Code plugin and registers commands for VS Code Plugin.
...
\begin{itemize}
    ...
    \item Required modules (SmellDetector, RefactorManager, FilterManager) are properly initialized
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Initializes SmellDetector module
        \item Initializes RefactorManager module
        \item Initializes FilterManager module
...
\subsection{Module}
\texttt{SmellDetector} analyzes Python files for code smells and manages the detection workflow.
