...
Simplify complex method chaining to improve decrease code CO2 emissions.
...
\begin{itemize}
  \item \textbf{output\_dir}: Directory where refactored files are stored.
...
\subsection{Uses}
Refactor long lambda functions into normal functions to improve readability, maintain functionality, and reduce CO2 emissions.
