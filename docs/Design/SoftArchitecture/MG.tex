...
\begin{figure}[H]
  ...
  \caption{VS Code Plugin Use Hierarchy among modules(yellow blocks, EcoOptimizer is green block. Note that colors of arrows are only intended for visual distinction)}
  \label{FigUH_Plugin}
  \end{figure}
