...
January 3rd, 2025 & Sevhena Walker & Modified template for static tests, clarified test-SRT-3\\
  ...
  April 1st, 2025 & Sevhena Walker & Modified Implementation Verification plan: refined unit testing tools. Updated Automated testing and Verification Tools to include plugin tools. Updated 4.2 to reflect the new tests.\\
  \bottomrule
\end{tabularx}
