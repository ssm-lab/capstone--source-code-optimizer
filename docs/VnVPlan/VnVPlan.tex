...
\noindent\textbf{Code Coverage Tools and Plan for Summary:} The code base will be analyzed to determine the percentage of code executed during tests. For granular-level coverage, \texttt{coverage.py} will be used, as it supports branch, line, and path coverage. Additionally, \texttt{coverage.py} is test framework-independent, allowing integration with the project's unit test framework, Pytest.\\
...
\begin{enumerate}[label={\bf \textcolor{Maroon}{test-FR-CSD-\arabic*}}, wide=0pt, font=\itshape]
  \item \textbf{Detection of Large Class (LC)}\\[2mm]
    \textbf{Control:} Automatic \\
    \textbf{Initial State:} Tool has loaded a \texttt{.py} file containing a class with a large number of methods and attributes.\\
...
\begin{enumerate}[label={\bf \textcolor{Maroon}{test-FR-DA-\arabic*}}, wide=0pt, font=\itshape]
  \item \textbf{Test for Documentation Availability}\\[2mm]
    \textbf{Control:} Manual
    \textbf{Initial State:} The may or may not be installed.\\
...
\begin{table}[H]
  \centering
  \caption{Look \& Feel Requirements and Corresponding Tests}
  \begin{tabular}{|c|c|}
...
\begin{table}[H]
  \centering
  \caption{Usability \& Humanity Requirements and Corresponding Tests}
  \begin{tabular}{|c|c|}
    \toprule \textbf{Test ID (test-)} & \textbf{Non-Functional Requirement} \\
    \midrule
...
\begin{table}[H]
  \centering
  \caption{Performance Requirements and Corresponding Tests}
  \begin{tabular}{|c|c|}
    \toprule \textbf{Test ID (test-)} & \textbf{Non-Functional Requirement} \\
    \midrule
    % Performance
...
\begin{table}[H]
  \centering
  \caption{Operational \& Environmental Requirements and Corresponding Tests}
  \begin{tabular}{|c|c|}
    \toprule \textbf{Test ID (test-)} & \textbf{Non-Functional Requirement} \\
    \midrule
    ...
    OPE-4 & OER-IAS 3 \\
    OPE-5 & OER-PR 1 \\
    Not explicitly tested & OER-RL 1 \\
...
\begin{table}[H]
  \centering
  \caption{Maintenance \& Support Requirements and Corresponding Tests}
  \begin{tabular}{|c|c|}
    \toprule \textbf{Test ID (test-)} & \textbf{Non-Functional Requirement} \\
    \midrule
...
\begin{table}[H]
  \centering
  \caption{Security Requirements and Corresponding Tests}
  \begin{tabular}{|c|c|}
    \toprule \textbf{Test ID (test-)} & \textbf{Non-Functional Requirement} \\
    \midrule
    % Security
...
\begin{table}[H]
  \centering
  \caption{Cultural Requirements and Corresponding Tests}
  \begin{tabular}{|c|c|}
    \toprule \textbf{Test ID (test-)} & \textbf{Non-Functional Requirement} \\
    \midrule
    % Cultural
...
\begin{table}[H]
  \centering
  \caption{Compliance Requirements and Corresponding Tests}
  \begin{tabular}{|c|c|}
    \toprule \textbf{Test ID (test-)} & \textbf{Non-Functional Requirement} \\
    \midrule
    % Compliance
