...
% TODO: Requirements traceability
\textbf{Target requirement(s):} FR4, FR7~\cite{SRS} \

\noindent
The smell detection module is responsible for identifying code smells in a given file based on the enabled smell types. Unit tests for this module validate the following aspects:
