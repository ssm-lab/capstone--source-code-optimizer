...
\begin{enumerate}
  ...
  \item \textbf{test-MS-1: Extensibility for New Code Smells and
    ...
    \begin{itemize}
      \item Adding a new detection module file \texttt{dup001\_detector.py} that scans for repeated list comprehensions
      \item Creating a new refactoring module file \texttt{dup001\_refactor.py} that implements the extraction logic
      \item Registering the new smell and refactoring in the configuration system
    \end{itemize}
