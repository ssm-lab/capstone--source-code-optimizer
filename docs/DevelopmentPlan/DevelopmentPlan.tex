...
The code in this repo is provided free to use under the MIT License. 
LICENSE file in root of repository.
\href{https://github.com/Sevhena/capstone--source-code-optimizer/blob/main/LICENSE}{Click to Open}
