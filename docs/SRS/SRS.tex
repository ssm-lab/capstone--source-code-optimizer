...
\begin{enumerate}[label=MD-SL \arabic*., wide=0pt, leftmargin=*]
    ...
    {\bf Fit Criterion:} The system must show at least a ENERGY\_SAVE reduction in energy consumption, as measured by tools like \texttt{PyJoules}, for most of the refactored code.\\
    {\bf Priority:} High
...
\begin{enumerate}[label=UHR-ACS \arabic*., wide=0pt, leftmargin=*]
    ...
    {\bf Fit Criterion:} The MIN\_USER\_EOU of users should report that the audio cues enhance their understanding of important notifications or actions.\\
    {\bf Priority:} Low
\end{enumerate}
