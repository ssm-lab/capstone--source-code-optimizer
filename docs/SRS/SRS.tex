...
\begin{enumerate}[{OER-EP}1. ]
    ...
    {\bf Rationale:} A computer's safe operating range is \SI{10}{\celsius} - \SI{35}{\celsius}. If the computer doesn't work then it is not possible to use the refactoring library. \\
...
\begin{enumerate}[{OER-WE}1. ]
	\item \emph{The system must align with widely used emissions standards (e.g., GRI 305, GHG, ISO 14064).}\\
