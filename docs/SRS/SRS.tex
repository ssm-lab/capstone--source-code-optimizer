...
For this I will conduct research on energy-efficient algorithms and their application in Python refactoring. This will give me the option to follow a hands on approach which allows to compare different strategies and asses their energy consumption in multiple scenarios.
