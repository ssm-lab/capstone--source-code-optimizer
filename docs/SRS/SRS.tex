...
\begin{enumerate}
  ...
  \begin{itemize}[label={}]
      \item \textbf{Fit Criteria:} Discrepancy reports to the user clearly highlight differences in outputs
  \end{itemize}
...
The Open Issues section outlines unresolved questions and challenges that may impact the development, functionality, or integration of the system. These issues require further research, discussion, or testing to ensure successful project completion.\\
