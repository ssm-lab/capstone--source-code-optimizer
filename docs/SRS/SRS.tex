...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|c|
    ...
    2 & Detect Code Smells & VS Code Plugin (via Refactoring Library) & Original Code (in), Identified Code Smells (out) \\ 
    3 & Select Code Smell for Refactoring & User & Selected Code Smell (in) \\ 
    4 & Refactor Code & VS Code Plugin (via Refactoring Library) & Code Segment (in), Refactored Code (out) \\ 
    5 & Measure Energy Consumption Before Refactoring & Refactoring Library (via Energy Measurement Tool) & Original Code (in), Initial Energy Consumption Results (out) \\ 
    6 & Measure Energy Consumption After Refactoring & Refactoring Library (via Energy Measurement Tool) & Refactored Code (in), Final Energy Consumption Results (out) \\ 
    7 & Show Results & VS Code Plugin & Refactored Code, Performance Metrics (out) \\ 
    \bottomrule
  \end{tabularx}
...
\textbf{Trigger:} User submits Python code via VS Code plugin. \\[2mm]
\textbf{Preconditions:}
\begin{itemize}
...
\textbf{Trigger:} Refactored code and energy consumption metrics are results. \\[2mm]
\textbf{Preconditions:}
\begin{itemize}
...
\textbf{Outcome:} The refactored code and energy consumption results are presented to the user. \\
