...
def main():
    ...
    TEST_FILE = os.path.abspath(os.path.join(DIRNAME, "../tests/input/ineffcient_code_example_1.py"))
    ...
    # Save code smells
    save_json_files("all_configured_pylint_smells.json", pylint_analyzer.smells_data, logger)
    ...
    if final_emission >= initial_emission:
        logger.log("Final emissions are greater than initial emissions; we are going to fail")
    else:
