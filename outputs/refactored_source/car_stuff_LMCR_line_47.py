...
class Car(Vehicle):
    ...
    def show_details(self):
        ...
        intermediate_0 = details
        intermediate_1 = intermediate_0.upper()
        intermediate_2 = intermediate_1.lower()
        intermediate_3 = intermediate_2.upper()
        intermediate_4 = intermediate_3.capitalize()
        intermediate_5 = intermediate_4.upper()
        result = intermediate_5.replace("|", "-")
        print(result)
