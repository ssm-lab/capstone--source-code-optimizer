class DataParams:
    ...
    def __init__(self, price, year, transmission, mileage, fuel_type, make,
        model, color):
        self.price = price
        self.year = year
...
class Car(Vehicle):
    ...
    def __init__(self, make, model, year, color, fuel_type, mileage,
        transmission, price, sunroof=False):
        super().__init__(make, model, year, color, fuel_type, mileage,
            transmission, price)
