...
class Vehicle:
    def __init__(
        ...
        self.make = data_params.make  # positional argument
        self.model = data_params.model
        self.year = data_params.year
        self.color = data_params.color
        self.fuel_type = data_params.fuel_type
        self.engine_start_stop_option = config_params.engine_start_stop_option
        self.mileage = data_params.mileage
        self.suspension_setting = config_params.suspension_setting
        self.transmission = data_params.transmission
        self.price = data_params.price
        self.seat_position_setting = config_params.seat_position_setting  # default value
...
class DataParams___init___15:
    def __init__(self, make, model, year, color, fuel_type, mileage, transmission, price):
        ...
        self.price = price
class ConfigParams___init___15:
    def __init__(self, engine_start_stop_option, suspension_setting, seat_position_setting = None):
        self.engine_start_stop_option = engine_start_stop_option
        self.suspension_setting = suspension_setting
        self.seat_position_setting = seat_position_setting
...
if __name__ == "__main__":
    ...
    car2 = Vehicle(
        DataParams___init___15("Honda", model = "Civic", year = 2018, color = "Red", fuel_type = "Gas", mileage = 30000, transmission = "Manual", price = 15000), ConfigParams___init___15(engine_start_stop_option = "key", suspension_setting = "Sport"))
